  ...
  >
    ...
    <el-table-column prop="orderStatus" label="订单状态" width="120">
      <template #default="scope">
        <el-tag type="warning" effect="dark" v-if="scope.row.orderStatus == 0"
          >未付款</el-tag
        >
        <el-tag type="success" effect="dark" v-if="scope.row.orderStatus == 1"
          >已付款</el-tag
        >
      </template>
    </el-table-column>
    ...
    <el-table-column prop="confirmStatus" label="确认订单状态" width="120">
      <template #default="scope">
        <el-tag type="danger" effect="dark" v-if="scope.row.confirmStatus == 0"
          >未发货</el-tag
        >
        <el-tag type="warning" effect="dark" v-if="scope.row.confirmStatus == 1"
          >已发货</el-tag
        >
        <el-tag type="" effect="dark" v-if="scope.row.confirmStatus == 2"
          >已收货</el-tag
        >
        <el-tag type="success" effect="dark" v-if="scope.row.confirmStatus == 3"
          >已完成</el-tag
        >
      </template>
    </el-table-column>
    ...
    <el-table-column fixed="right" label="操作" width="200">
      <template #default="scope">
        <el-button
          ...
          type="danger"
          size="small"
          v-if="scope.row.confirmStatus == 3 && scope.row.orderStatus == 1"
        ...
        <el-button
          ...
          type="info"
          size="small"
          v-if="scope.row.confirmStatus == 0 && scope.row.orderStatus == 0"
          >等待买家付款</el-button
        >
        <el-button
          link
        ...
        <el-button
          ...
          size="small"
          v-if="
            (scope.row.confirmStatus == 2 && scope.row.orderStatus == 1) ||
...
onMounted(async () => {
  tableData.value = await selectOrderAllByShopUserId(
